    ...
    <div class="size">
        ...
        <div class="workzone">
            <div class="cmainimg">
             ...
             <form action="search_bus_by_reg.jsp">
<table align="center">
<tr><td>Bus Reg.<input type="text" name="busreg" id="busreg"><input type="submit" name="search" id="search" value="Search"></td></tr>
</table>
</form>
                  
  <%

if(request.getParameter("busreg")==null)
{
...
<tr><th>IMEI</th><th> &nbsp;&nbsp;&nbsp;&nbsp;BUS NO. &nbsp;&nbsp;&nbsp;&nbsp;</th><th> &nbsp;&nbsp;&nbsp;&nbsp;REG NO. &nbsp;&nbsp;&nbsp;&nbsp;</th></tr>
	<%
try{
...
String busreg = request.getParameter("busreg");

ResultSet buffer = stmt.executeQuery("SELECT * FROM Bus_details where Reg_no like '"+busreg+"' ");
while(buffer.next())
{
