    ...
    <div class="size">
        ...
        <div class="workzone">
            <div class="cmainimg">
             ...
             <form action="Search_Bus_routes.jsp">
<table align="center">
...
ResultSet buffer = stmt.executeQuery("SELECT * FROM busnumber where Bus_no like '"+busnum+"' ");
int i=0;
while(buffer.next())
{
	i=i+1;
	...
	<td><%=To_%></td>
	<td><%=Via%></td>
	<td><a target="iframe"  href="Mapview.jsp?busstops=<%=Via%>">click</a></td>
	</tr>
